...
export const defaultApiUrl = 'ws://127.0.0.1:9977'//`wss://${process.env.APP_PHALA_URL}/ws`

export default () => {
  const store = createPersistStore('settings', SettingsStore, {
    id: 'appSettings',
    phalaTeeApiUrl: 'http://127.0.0.1:8000'//`https://${process.env.APP_PHALA_URL}/tee-api/`
  })
